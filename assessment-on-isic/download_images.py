...
Examples:
  python download_images.py isic-100-image-ids.txt --out isic_data --xlsx
  python download_images.py ham10k-500-image-ids.txt --out ham10k_images --xlsx
  # python download_images.py isic-100-image-ids.txt --id-col isic_id --out isic_out --workers 8 --skip-existing
"""
